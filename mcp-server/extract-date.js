...
async function main() {
  ...
  const date20251111 = data.byDate['2025-11-11'] || [];
  const result = {};
  
  date20251111.forEach(item => {
  ...
  await fs.writeFile('data/processed-rss-2025-11-11.json', JSON.stringify(result, null, 2));
  console.log('提取完成，共', date20251111.length, '条');
