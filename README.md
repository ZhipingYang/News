...
1. **RSS源抓取** - 从41个优质RSS源抓取最新资讯（成功率82.9%）
2. **去重检查** - 移除所有重复内容（相似度≥80%）
3. **可信度评估** - 只接受可信度≥0.85的高质量资讯
4. **智能补充** - AI动态判断是否需要web_search补充资讯
5. **重要资讯扩展** - 对高影响力资讯进行深度搜索和扩展分析
6. **内容压缩** - 智能提取关键信息，压缩上下文至30-40%
7. **深度分析生成** - 生成1500-2000字专业分析
8. **网站构建** - 自动生成静态网站
9. **Git推送** - 使用GitHub CLI或Token自动推送
...
### RSS源配置
- **ai-programming**: 11个高质量源（GitHub、JetBrains、Microsoft等）
- **ai-products**: 15个高质量源（Google AI、Microsoft、NVIDIA等）
- **tech-general**: 15个高质量源（MIT Tech Review、IEEE、Nature等）
- **总计**: 41个优质RSS源，成功率82.9%，可信度≥0.8
